...
export const routes: Routes = [
  ...
  { path: 'register', loadComponent: () => import('./features/auth/register/register.component').then(c => c.RegisterComponent) },
  {
    ...
    children: [
      ...
      { path: 'proveedores', loadComponent: () => import('./features/proveedores/proveedor-list/proveedor-list.component').then(c => c.ProveedorListComponent), canActivate: [roleGuard], data: { roles: ['ROLE_ADMINISTRADOR', 'ROLE_AUTORIDAD', 'ROLE_SUPER_ADMIN', 'ROLE_GESTOR_LICITACIONES', 'ROLE_ADMIN'] } },
